...
public class ApiApiController implements ApiApi {
    ...
    public ResponseEntity<List<Object>> getCustomerUsingGET(@Parameter(in = ParameterIn.PATH, description = "id", required=true, schema=@Schema()) @PathVariable("id") Long id) {
